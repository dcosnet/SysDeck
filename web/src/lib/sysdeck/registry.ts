...
// manifests (menu order 20–45) plus the new Overview landing view and
// the previously-orphaned Hardware Alerts module.
...
export const MODULES: ModuleMeta[] = [
  ...
  { id: 'packages', name: 'Packages', group: 'system', order: 37, description: 'Package inventory, updates and operations via dpkg/apt.', status: 'live' },
  ...
  // ── security ────────────────────────────────────────────
  { id: 'firewall', name: 'Firewall', group: 'security', order: 21, description: 'Rulesets, zones and deployable firewall templates (public-webserver, vps-webserver, ai-llm, remote-admin, no-services, cilium).', interactive: true, status: 'demo' },
  { id: 'netsec', name: 'Network Security', group: 'security', order: 23, description: 'Connection states, listening surfaces, ban list and port sweeps.', interactive: true, status: 'hybrid' },
  ...
  { id: 'auth', name: 'Hardware Auth', group: 'security', order: 33, description: 'PKCS#11 smartcard readers, certificates and hardware tokens.', status: 'demo' },
  { id: 'hwalert', name: 'Hardware Alerts', group: 'security', order: 46, description: 'Foreign-device detection — USB storage, Thunderbolt DMA, rogue bluetooth, new PCI, firmware tamper. The orphaned bridge finally gets its panel.', interactive: true, status: 'hybrid' },
  { id: 'policy', name: 'Policy', group: 'security', order: 38, description: 'Polkit-style policy and permission rules with an audit trail.', interactive: true, status: 'demo' },

  // ── compute ─────────────────────────────────────────────
  { id: 'containers', name: 'Containers & VMs', group: 'compute', order: 20, description: 'Incus / LXC / Podman / libvirt / Firecracker inventory with lifecycle actions.', interactive: true, status: 'demo' },
  { id: 'mesh', name: 'Service Mesh', group: 'compute', order: 24, description: 'Kubernetes services, deployments and pods across namespaces.', status: 'demo' },
  { id: 'kata', name: 'Kata', group: 'compute', order: 27, description: 'Kata Containers confidential-compute sandboxes.', status: 'demo' },
  { id: 'remotefs', name: 'Remote FS', group: 'compute', order: 42, description: 'Ceph / GlusterFS / MooseFS / BeeGFS / OrangeFS distributed filesystems.', status: 'demo' },
  ...
  { id: 'builder', name: 'Image Builder', group: 'build', order: 30, description: 'mkosi / vmdb2 / archiso / live-build profile management with package lists, build runs and artifacts.', interactive: true, status: 'demo' },
  { id: 'mining', name: 'Mining', group: 'build', order: 31, description: 'Rig fleet, per-GPU hashrate and thermal watch.', status: 'demo' },

  // ── media ───────────────────────────────────────────────
  { id: 'jellyfin', name: 'Jellyfin', group: 'media', order: 40, description: 'Media server library and active sessions.', status: 'demo' },
  { id: 'photos', name: 'Photos', group: 'media', order: 41, description: 'PhotoPrism / Piwigo / Lychee / Nextcloud-Memories / LibrePhotos libraries.', status: 'demo' },
